...
<template>
  <div class="absolute inset-0 w-full h-full flex flex-col justify-between select-none overflow-hidden bg-black p-12 px-14 text-left font-['Nanum_Gothic',sans-serif]">
    ...
    <div class="relative z-10">
      <span class="inline-block text-xs md:text-sm font-bold tracking-widest text-white uppercase pure-white-text">
        2026 사회서비스 종사자 디지털 교육
      </span>
    </div>

    <!-- ── Center: Apple Keynote Statement Layout (100% Pure White Floating Title) ── -->
    <div class="relative z-10 my-auto max-w-3xl space-y-4 pt-2">
      <h1 class="text-4xl md:text-[54px] font-extrabold leading-[1.2] tracking-tight pure-white-title">
        AI를 활용한<br>
        문서 작성 협업 역량 강화
      </h1>

      <p class="text-sm md:text-base font-normal leading-relaxed max-w-xl pure-white-sub">
        생성형 AI의 작동 원리부터 실무 표준 지시, 도구 협업, 나만의 스킬 자산화까지
      </p>
    </div>
