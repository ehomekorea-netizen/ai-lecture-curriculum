...
<v-clicks>
  <div class="glass-card p-5 flex flex-col justify-between border-t-2 border-t-sky-400">
    <div>
      <div class="flex items-center justify-between mb-2">
        <span class="text-xs font-mono text-sky-400 font-bold uppercase tracking-wider">Session 01</span>
        <span class="i-carbon-data-volume text-sky-400 text-lg"></span>
      </div>
      <h3 class="font-bold text-white text-base mt-1 mb-2">데이터와 ML·DL 원리</h3>
      <p class="text-xs text-white/70 leading-relaxed">"양식장 빅데이터와 머신러닝·딥러닝의 본질"</p>
    </div>
    <div class="text-[11px] text-white/60 border-t border-white/10 pt-3 mt-3 leading-relaxed">
      • 가두리 40만 행 데이터<br>• 규칙 기반 vs 머신러닝<br>• 딥러닝과 수중영상 인식
    </div>
  </div>

  <div class="glass-card p-5 flex flex-col justify-between border-t-2 border-t-indigo-400">
    <div>
      <div class="flex items-center justify-between mb-2">
        <span class="text-xs font-mono text-indigo-400 font-bold uppercase tracking-wider">Session 02</span>
        <span class="i-carbon-dashboard text-indigo-400 text-lg"></span>
      </div>
      <h3 class="font-bold text-white text-base mt-1 mb-2">AI 4유형과 도입 검증</h3>
      <p class="text-xs text-white/70 leading-relaxed">"해상가두리 AI 4유형과 정확도 97%의 함정"</p>
    </div>
    <div class="text-[11px] text-white/60 border-t border-white/10 pt-3 mt-3 leading-relaxed">
      • 예측/인식/최적화/문서소통<br>• 경보 읽는 4원칙<br>• 재현율 vs 정밀도 체크리스트
    </div>
  </div>

  <div class="glass-card p-5 flex flex-col justify-between border-t-2 border-t-amber-400">
    <div>
      <div class="flex items-center justify-between mb-2">
        <span class="text-xs font-mono text-amber-400 font-bold uppercase tracking-wider">Session 03</span>
        <span class="i-carbon-chat-bot text-amber-400 text-lg"></span>
      </div>
      <h3 class="font-bold text-white text-base mt-1 mb-2">생성형 AI와 RCTF</h3>
      <p class="text-xs text-white/70 leading-relaxed">"양식일지 자동화와 환각 잡는 RAG"</p>
    </div>
    <div class="text-[11px] text-white/60 border-t border-white/10 pt-3 mt-3 leading-relaxed">
  ...
  <div class="glass-card p-5 flex flex-col justify-between border-t-2 border-t-emerald-400">
    <div>
      <div class="flex items-center justify-between mb-2">
        <span class="text-xs font-mono text-emerald-400 font-bold uppercase tracking-wider">Session 04</span>
        <span class="i-carbon-bot text-emerald-400 text-lg"></span>
      </div>
      <h3 class="font-bold text-white text-base mt-1 mb-2">에이전트 & 실천 로드맵</h3>
      <p class="text-xs text-white/70 leading-relaxed">"아침 06시 자동 브리핑과 단계별 도입"</p>
    </div>
    <div class="text-[11px] text-white/60 border-t border-white/10 pt-3 mt-3 leading-relaxed">
      • 챗봇 vs AI 에이전트<br>• 06:00 브리핑 시뮬레이션<br>• 도입 우선순위 & 4단계 로드맵
    </div>
  </div>
</v-clicks>
</div>
...
<v-clicks>
  <div class="glass-card border-sky-500/20 p-5 flex flex-col justify-between">
    ...
    <div class="text-xs text-sky-300 border-t border-white/10 pt-3 mt-3 font-medium">
      도입 타당성 평가 역량
    </div>
  </div>
  ...
  <div class="glass-card border-emerald-500/20 p-5 flex flex-col justify-between">
    ...
    <div class="text-xs text-emerald-300 border-t border-white/10 pt-3 mt-3 font-medium">
      경보 해석 및 현장 검증 역량
    </div>
  </div>
  ...
  <div class="glass-card border-purple-500/20 p-5 flex flex-col justify-between">
    ...
    <div class="text-xs text-purple-300 border-t border-white/10 pt-3 mt-3 font-medium">
      데이터 자산화 관리 역량
    </div>
  </div>
</v-clicks>
...
<v-clicks>
  <div class="glass-card flex flex-col justify-between border-sky-500/20 p-5">
    <div>
      ...
      <p class="text-xs text-white/75 mt-4 leading-relaxed">
        연간 40만 행은 <strong>사람이 엑셀을 열고 눈으로 훑어서 패턴을 찾을 수 있는 한계를 완전히 넘어선 규모</strong>입니다.
      </p>
    </div>
    <div class="p-3 bg-white/5 rounded-lg text-xs text-white/85 border border-white/10 mt-3">
      👉 <strong>현장 분업의 원칙:</strong> 대량 데이터 판독은 <strong>AI</strong>가 수행하고, 사람은 그 결과에 근거하여 <strong>사육 조치와 경영 판단</strong>을 내린다.
    </div>
  </div>
  ...
  <div class="glass-card border-indigo-500/20 bg-indigo-950/10 flex flex-col justify-between p-5">
    ...
    <div class="text-xs text-indigo-300 font-mono text-center mt-3 font-bold">
      해상가두리는 이미 빅데이터 생산 공장입니다.
    </div>
  </div>
</v-clicks>
</div>
...
<div class="grid grid-cols-2 gap-5 my-4">
  <div class="glass-card border-rose-500/20 bg-rose-950/10 p-5 flex flex-col justify-between">
    <div>
      <div class="text-sm text-rose-300 font-bold mb-3 flex items-center gap-2">
      ...
      <ul class="space-y-3 text-xs text-white/80">
        <li class="p-3 bg-black/40 rounded-lg">
          <strong class="text-rose-300 text-sm">"오늘 A동 폐사 좀 많았음"</strong><br>
          <span class="text-white/60 text-xs">→ 주관적 서술형 표현은 머신러닝 학습 불가</span>
        </li>
        <li class="p-3 bg-black/40 rounded-lg">
          <strong class="text-rose-300 text-sm">"전체 가두리 합산 폐사 150마리"</strong><br>
          <span class="text-white/60 text-xs">→ 어느 동에서 터졌는지 위치 식별 불가</span>
        </li>
        <li class="p-3 bg-black/40 rounded-lg">
          <strong class="text-rose-300 text-sm">"측정 안 한 날은 그냥 0으로 적음"</strong><br>
          <span class="text-white/60 text-xs">→ 수온 0℃로 오인식하여 모델 왜곡</span>
        </li>
      </ul>
    </div>
  </div>

  <div class="glass-card border-emerald-500/20 bg-emerald-950/10 p-5 flex flex-col justify-between">
    <div>
      <div class="text-sm text-emerald-300 font-bold mb-3 flex items-center gap-2">
        <span class="i-carbon-checkmark-filled text-emerald-400 text-base"></span>
        <span>⭕ AI가 즉시 학습 가능한 표준 기록 4원칙</span>
      </div>
      <ul class="space-y-3 text-xs text-white/90">
        <li class="p-3 bg-black/40 rounded-lg flex items-start gap-2.5">
          <span class="i-carbon-grid text-emerald-400 text-lg flex-shrink-0 mt-0.5"></span>
          <div>
            <strong class="text-emerald-300 text-sm">1. 가두리 동별 분리 기록:</strong><br>
            <span class="text-white/75 text-xs">A-01, A-02 가두리별로 발생 위치를 명확히 분리</span>
          </div>
        </li>
        <li class="p-3 bg-black/40 rounded-lg flex items-start gap-2.5">
          <span class="i-carbon-string-integer text-emerald-400 text-lg flex-shrink-0 mt-0.5"></span>
          <div>
            <strong class="text-emerald-300 text-sm">2. 정량 수치 표기:</strong><br>
            <span class="text-white/75 text-xs">"폐사 42미", "급이 120kg" 숫자로 정확히 기록</span>
          </div>
        </li>
        <li class="p-3 bg-black/40 rounded-lg flex items-start gap-2.5">
          <span class="i-carbon-rule text-emerald-400 text-lg flex-shrink-0 mt-0.5"></span>
          <div>
            <strong class="text-emerald-300 text-sm">3. 결측치(빈칸) 구분:</strong><br>
            <span class="text-white/75 text-xs">측정하지 못한 값은 0이 아닌 빈칸(결측)으로 처리</span>
          </div>
        </li>
      </ul>
    </div>
...
<div class="glass-card p-4 my-3 text-xs text-white/85">
  <table class="w-full text-left border-collapse text-xs">
    <thead>
      <tr class="border-b border-white/20 text-white/50 text-xs">
        <th class="py-2.5 px-3">데이터 항목</th>
        <th class="py-2.5 px-3">자동 수집</th>
        <th class="py-2.5 px-3">수기 기록</th>
        <th class="py-2.5 px-3">AI 활용 가능성 & 목적</th>
      </tr>
    </thead>
    <tbody class="divide-y divide-white/10">
      <tr class="hover:bg-white/5">
        <td class="py-3 px-3 font-bold text-white text-sm">수온 · DO · 염분</td>
        <td class="py-3 px-3 text-sky-300 font-mono">센서 (10분)</td>
        <td class="py-3 px-3 text-white/50">-</td>
        <td class="py-3 px-3 text-emerald-300 font-medium">수질 이상탐지 및 고수온 조기 경보</td>
      </tr>
      <tr class="hover:bg-white/5">
        <td class="py-3 px-3 font-bold text-white text-sm">급이량 (동별)</td>
        <td class="py-3 px-3 text-white/50">-</td>
        <td class="py-3 px-3 text-amber-300 font-mono">일지 (kg)</td>
        <td class="py-3 px-3 text-emerald-300 font-medium">사료 계수(FCR) 및 성장 곡선 분석</td>
      </tr>
      <tr class="hover:bg-white/5">
        <td class="py-3 px-3 font-bold text-white text-sm">폐사수 (동별·일별)</td>
        <td class="py-3 px-3 text-white/50">-</td>
        <td class="py-3 px-3 text-amber-300 font-mono">수거 기록</td>
        <td class="py-3 px-3 text-rose-300 font-medium font-bold">폐사 위험 예측 모델의 정답(Label) 데이터</td>
      </tr>
      <tr class="hover:bg-white/5">
        <td class="py-3 px-3 font-bold text-white text-sm">수중 영상</td>
        <td class="py-3 px-3 text-sky-300 font-mono">수중 카메라</td>
        <td class="py-3 px-3 text-white/50">-</td>
        <td class="py-3 px-3 text-purple-300 font-medium">딥러닝 어체 계수, 체중 추정, 질병 탐지</td>
      </tr>
      <tr class="hover:bg-white/5">
        <td class="py-3 px-3 font-bold text-white text-sm">작업일지 메모</td>
        <td class="py-3 px-3 text-white/50">-</td>
        <td class="py-3 px-3 text-amber-300 font-mono">구어체 메모</td>
        <td class="py-3 px-3 text-amber-300 font-medium">생성형 AI 일지 자동 정리 및 RAG 재료</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div class="p-3 bg-white/5 rounded-xl text-xs text-white/85 border border-white/10 text-center mt-3">
...
<div class="flex items-center justify-center my-4">
  <img src="/ai-ml-dl-hierarchy.png" alt="인공지능 머신러닝 딥러닝 포함 관계" class="rounded-xl max-h-76 w-auto object-contain shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/10" />
</div>
...
<v-clicks>
  <div class="glass-card border-sky-500/20 p-5 flex flex-col justify-between">
    <div>
      <div class="flex items-center justify-between mb-2">
        <span class="text-xs font-mono text-sky-300 font-bold uppercase tracking-wider">Concept 01</span>
        <span class="i-carbon-machine-learning-model text-sky-400 text-xl"></span>
      </div>
      <h3 class="text-base font-bold text-white mt-1.5 mb-2">인공지능 (AI)</h3>
      <p class="text-xs text-white/75 leading-relaxed">
  ...
  <div class="glass-card border-indigo-500/20 p-5 flex flex-col justify-between">
    <div>
      <div class="flex items-center justify-between mb-2">
        <span class="text-xs font-mono text-indigo-300 font-bold uppercase tracking-wider">Concept 02</span>
        <span class="i-carbon-chart-multitype text-indigo-400 text-xl"></span>
      </div>
      <h3 class="text-base font-bold text-white mt-1.5 mb-2">머신러닝 (ML)</h3>
      <p class="text-xs text-white/75 leading-relaxed">
        사람이 규칙을 직접 코딩하지 않고, 축적된 표 형태 데이터에서 컴퓨터가 스스로 위험 패턴과 규칙을 도출
      </p>
    </div>
    <div class="text-xs text-indigo-300 border-t border-white/10 pt-3 mt-3 font-medium">
  ...
  <div class="glass-card border-purple-500/20 p-5 flex flex-col justify-between">
    <div>
      <div class="flex items-center justify-between mb-2">
        <span class="text-xs font-mono text-purple-300 font-bold uppercase tracking-wider">Concept 03</span>
        <span class="i-carbon-network-4 text-purple-400 text-xl"></span>
      </div>
      <h3 class="text-base font-bold text-white mt-1.5 mb-2">딥러닝 (DL)</h3>
      <p class="text-xs text-white/75 leading-relaxed">
...
<div class="flex items-center justify-center my-4">
  <img src="/rule-vs-ml.png" alt="규칙 기반 vs 머신러닝" class="rounded-xl max-h-76 w-auto object-contain shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/10" />
</div>
...
<v-clicks>
  <div class="glass-card border-rose-500/20 bg-rose-950/15 p-5 flex flex-col justify-between">
    <div>
      <div class="text-sm text-rose-300 font-bold mb-3">단순 조건식 경보의 현실</div>
      <div class="p-3 bg-black/40 rounded-xl text-xs font-mono text-rose-300 mb-3">
    ...
    <div class="text-xs text-rose-400 font-bold border-t border-rose-500/20 pt-3 mt-3">
      결과: 조건이 늘어날수록 사람이 모든 조합의 예외 규칙을 작성할 수 없음!
    </div>
  </div>

  <div class="glass-card border-emerald-500/20 bg-emerald-950/15 p-5 flex flex-col justify-between">
    <div>
      <div class="text-sm text-emerald-300 font-bold mb-3">머신러닝의 역전 발상</div>
      <div class="p-3 bg-black/40 rounded-xl text-xs font-mono text-emerald-300 mb-3">
        과거 3년 센서 기록 + 폐사 여부 결과 → 컴퓨터가 복합 위험 조합 도출
      </div>
      <p class="text-xs text-white/85 leading-relaxed">
        사람이 일일이 if문을 작성하지 않아도, 컴퓨터가 과거 폐사 사례들의 공통적인 복합 환경 패턴을 스스로 학습하여 모델을 생성합니다.
      </p>
    </div>
    <div class="text-xs text-emerald-300 font-bold border-t border-emerald-500/20 pt-3 mt-3">
      효과: 사람이 미처 생각하지 못한 다차원 이상 징후 포착 가능
    </div>
  </div>
</v-clicks>
</div>
...
<v-clicks>
  <div class="glass-card border-sky-500/20 p-4 text-center">
    <span class="text-[11px] font-mono text-sky-300 font-bold">STEP 01</span>
    <h4 class="text-sm font-bold text-white mt-1.5 mb-1.5">예측값 산출</h4>
    <p class="text-xs text-white/65">현재 모델이 폐사 위험 확률을 계산</p>
  </div>
  <div class="glass-card border-sky-500/20 p-4 text-center">
    <span class="text-[11px] font-mono text-sky-300 font-bold">STEP 02</span>
    <h4 class="text-sm font-bold text-white mt-1.5 mb-1.5">오차(Error) 측정</h4>
    <p class="text-xs text-white/65">실제 폐사 발생 여부와 차이 계산</p>
  </div>
  <div class="glass-card border-sky-500/20 p-4 text-center">
    <span class="text-[11px] font-mono text-sky-300 font-bold">STEP 03</span>
    <h4 class="text-sm font-bold text-white mt-1.5 mb-1.5">가중치 미세 조정</h4>
    <p class="text-xs text-white/65">오차가 줄어드는 방향으로 내부 값 수정</p>
  </div>
  <div class="glass-card border-emerald-500/20 p-4 text-center">
    <span class="text-[11px] font-mono text-emerald-300 font-bold">STEP 04</span>
    <h4 class="text-sm font-bold text-white mt-1.5 mb-1.5">반복 최적화</h4>
    <p class="text-xs text-white/65">전체 데이터에 대해 수천 번 반복 완료</p>
  </div>
</v-clicks>
</div>

<div class="grid grid-cols-2 gap-4 text-xs mt-3">
  <div class="p-3.5 bg-rose-950/20 border border-rose-500/20 rounded-xl">
    <strong class="text-rose-300 text-sm">실무적 함의 1:</strong><br>
    <span class="text-white/75 text-xs leading-relaxed">오차가 최소인 답을 고를 뿐이므로 항상 오류 가능성이 존재함</span>
  </div>
  <div class="p-3.5 bg-amber-950/20 border border-amber-500/20 rounded-xl">
    <strong class="text-amber-300 text-sm">실무적 함의 2:</strong><br>
    <span class="text-white/75 text-xs leading-relaxed">과거 데이터에 한 번도 없었던 이례적 냉수대나 태풍은 예측 불가</span>
  </div>
</div>
...
<div class="flex items-center justify-center my-4">
  <img src="/ml-vs-dl.png" alt="머신러닝 딥러닝 차이점" class="rounded-xl max-h-76 w-auto object-contain shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/10" />
</div>
...
<v-clicks>
  <div class="glass-card border-sky-500/20 p-4">
    <div class="flex items-center gap-2 text-sky-300 font-bold text-sm mb-1.5">
      ...
      <span>1. 어체 개체수 계수 (Counting)</span>
    </div>
...
<div class="grid grid-cols-2 gap-4 text-xs mt-3">
  <div class="p-3.5 bg-white/5 rounded-xl border border-white/10">
    <strong class="text-sky-300 text-sm">해상가두리 (조피볼락/돔):</strong><br>
    <span class="text-white/75 text-xs mt-1 block">자연 해역 노출로 수온 급변·적조·저산소 조기 경보가 생존의 핵심</span>
  </div>
  <div class="p-3.5 bg-white/5 rounded-xl border border-white/10">
    <strong class="text-purple-300 text-sm">육상수조 (넙치):</strong><br>
    <span class="text-white/75 text-xs mt-1 block">수조 조명과 시야 확보가 유리하여 수중영상 어체 계수와 섭이 분석 우선 도입</span>
  </div>
</div>
...
<div class="max-w-3xl mx-auto glass-card p-6 my-6 space-y-4 text-sm text-white/90">
  <div class="flex items-center gap-3">
    ...
    <p class="leading-relaxed"><strong>가두리 양식장은 상시 빅데이터 생산자:</strong> 8개 동 연간 40만 행 데이터는 AI와 분업해야 관리 가능</p>
  </div>
  <div class="flex items-center gap-3">
    ...
    <p class="leading-relaxed"><strong>기록의 4대 원칙:</strong> 동별 분리, 숫자 기록, 결측 구분, 1행 1관측이 지켜져야 AI가 성립함</p>
  </div>
  <div class="flex items-center gap-3">
    ...
    <p class="leading-relaxed"><strong>머신러닝 vs 딥러닝:</strong> 센서 수치는 머신러닝으로 충분, 카메라 영상이 개입할 때 딥러닝 도입</p>
  </div>
</div>
...
<div class="flex items-center justify-center my-4">
  <img src="/aquaculture-4types.png" alt="해상가두리 AI 활용 4유형" class="rounded-xl max-h-76 w-auto object-contain shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/10" />
</div>

<div class="grid grid-cols-4 gap-3 text-xs text-center text-white/80 mt-2">
<v-clicks>
  <div class="p-2 bg-sky-950/20 border border-sky-500/20 rounded-lg font-medium">① 예측형: 미리 아는 것</div>
  <div class="p-2 bg-indigo-950/20 border border-indigo-500/20 rounded-lg font-medium">② 인식형: 보이지 않는 것을 보는 것</div>
  <div class="p-2 bg-emerald-950/20 border border-emerald-500/20 rounded-lg font-medium">③ 최적화형: 더 나은 선택을 찾는 것</div>
  <div class="p-2 bg-amber-950/20 border border-amber-500/20 rounded-lg font-medium">④ 문서·소통형: 오늘부터 쓸 수 있는 것</div>
</v-clicks>
</div>
...
<v-clicks>
  <div class="glass-card p-5 flex flex-col justify-between border-sky-500/20">
    <div>
      <div class="text-sm text-sky-300 font-bold mb-3">수온 상승과 폐사 발생의 시차 (Time-lag)</div>
    ...
    <div class="p-2.5 bg-sky-950/30 border border-sky-500/20 rounded-lg text-xs text-sky-300 font-medium">
      ⏱️ 1~2일 전 사전 인지 → 차광막 하강, 액화산소 비축, 급이 감량, 인력 배치 완료!
    </div>
  </div>

  <div class="glass-card p-5 flex flex-col justify-between border-emerald-500/20 bg-emerald-950/10">
    <div>
      <div class="text-sm text-emerald-300 font-bold mb-3">현장 선제 대응 행동 시나리오</div>
      <ul class="space-y-2.5 text-xs text-white/90">
        <li class="p-2 bg-black/40 rounded-lg flex items-center gap-2">
          <span class="i-carbon-sun text-amber-400 text-base"></span>
          <span><strong class="text-emerald-300">1. 차광막 전면 하강:</strong> 직사광선 차단 및 표층 수온 완화</span>
        </li>
        <li class="p-2 bg-black/40 rounded-lg flex items-center gap-2">
          <span class="i-carbon-cut text-sky-400 text-base"></span>
          <span><strong class="text-emerald-300">2. 사료 급이 50% 감량 / 절식:</strong> 소화 대사열 발생 억제</span>
        </li>
        <li class="p-2 bg-black/40 rounded-lg flex items-center gap-2">
          <span class="i-carbon-chemistry text-teal-400 text-base"></span>
          <span><strong class="text-emerald-300">3. 액화산소 라인 점검:</strong> 야간 저산소 대비 토출 밸브 개방</span>
        </li>
        <li class="p-2 bg-black/40 rounded-lg flex items-center gap-2">
          <span class="i-carbon-flash text-purple-400 text-base"></span>
...
<v-clicks>
  <div class="glass-card border-sky-500/20 p-4">
    <strong class="text-sky-300 text-sm">1. 예측값은 점이 아니라 '범위'로 해석</strong>
    <p class="text-white/75 text-xs mt-1.5 leading-relaxed">
      "3일 후 27.2℃"라는 예측은 정확히 27.2℃가 된다는 뜻이 아니라, <strong>±1.5℃ 구간(25.7~28.7℃)의 상승 가능성</strong>이 높다는 의미로 해석해야 합니다.
    </p>
  </div>

  <div class="glass-card border-emerald-500/20 p-4">
    <strong class="text-emerald-300 text-sm">2. 조치의 최종 근거는 '현장 실측값'</strong>
    <p class="text-white/75 text-xs mt-1.5 leading-relaxed">
  ...
  <div class="glass-card border-amber-500/20 p-4">
    <strong class="text-amber-300 text-sm">3. 과거에 없던 이례적 사건 주의</strong>
    <p class="text-white/75 text-xs mt-1.5 leading-relaxed">
  ...
  <div class="glass-card border-purple-500/20 p-4">
    <strong class="text-purple-300 text-sm">4. 연 1회 이상 모델 재평가 요구</strong>
    <p class="text-white/75 text-xs mt-1.5 leading-relaxed">
...
<v-clicks>
  <div class="glass-card border-emerald-500/30 bg-emerald-950/20 p-5 flex flex-col justify-between">
    <div>
      <div class="text-emerald-300 font-bold text-base mb-1.5 flex items-center gap-2">
        ...
        <span>재현율 (Recall) ⭐ 수산양식 최우선 지표</span>
      </div>
    ...
    <div class="mt-3 text-xs text-emerald-300 font-bold border-t border-emerald-500/20 pt-2.5">
  ...
  <div class="glass-card border-sky-500/30 bg-sky-950/20 p-5 flex flex-col justify-between">
    ...
    <div class="mt-3 text-xs text-sky-300 font-bold border-t border-sky-500/20 pt-2.5">
...
<div class="flex items-center justify-center my-3">
  <img src="/pretraining-vs-finetuning.png" alt="사전학습과 파인튜닝 구조" class="rounded-xl max-h-68 w-auto object-contain shadow-lg" />
</div>

<div class="p-3.5 bg-white/5 rounded-xl border border-white/10 text-xs text-white/85 leading-relaxed text-center mt-2">
...
<v-clicks>
  <div class="glass-card border-rose-500/20 p-5 text-xs">
  ...
  <div class="glass-card border-emerald-500/20 bg-emerald-950/15 p-5 text-xs">
    <div class="text-emerald-300 font-bold text-sm mb-2 flex items-center gap-2">
      ...
      <span>현장 엣지(Edge) AI 백업 체계</span>
    </div>
    <p class="text-white/85 text-xs leading-relaxed">
...
<div class="p-3 bg-white/5 rounded-xl text-xs text-white/85 border border-white/10 text-center mt-3">
  💡 <strong>필수 점검:</strong> 인터넷이 끊겨도 현장 가두리에서 소리 경보와 산소 공급기 제어가 되는가?
</div>
...
<v-clicks>
  <div class="flex items-center gap-3">
    ...
    <p class="leading-relaxed"><strong>예측의 가치는 골든타임 확보:</strong> 수온 상승 후 폐사까지 수일의 시차가 있으므로 1~2일 전 사전 인지가 생명</p>
  </div>
  <div class="flex items-center gap-3">
    ...
    <p class="leading-relaxed"><strong>정확도 97%의 함정 극복:</strong> 폐사·질병 예방에서는 재현율(Recall)을 최우선으로 검증</p>
  </div>
  <div class="flex items-center gap-3">
    ...
    <p class="leading-relaxed"><strong>도입 체크리스트 7개 이상:</strong> 데이터 소유권, 재학습 비용, 오작동 책임 한계를 반드시 계약서에 명시</p>
  </div>
</v-clicks>
</div>
...
<div class="mb-3">
  <h2 class="stage-title">WS-1 실습 워크시트 : 내 어장 AI 도입 우선순위</h2>
</div>
...
<div class="flex items-center justify-center my-4">
  <img src="/hallucination-macbook.png" alt="세종대왕 맥북프로 던짐 사건" class="rounded-xl max-h-76 w-auto object-contain shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/10" />
</div>
...
<v-clicks>
  <div class="glass-card border-rose-500/20 p-4">
    <strong class="text-rose-300 text-sm">1. 존재하지 않는 법령·고시 조항 날조</strong>
    <p class="text-white/75 text-xs mt-1.5 leading-relaxed">
  ...
  <div class="glass-card border-rose-500/20 p-4">
    <strong class="text-rose-300 text-sm">2. 비공개 양식장 내부 사정 추측</strong>
    <p class="text-white/75 text-xs mt-1.5 leading-relaxed">
      우리 가두리 동별 수심이나 사육 마릿수를 입력하지 않았는데도, <strong>AI가 마음대로 5만 마리로 가정한 뒤 급이량을 계산</strong>하여 사료 낭비 초래
    </p>
  </div>

  <div class="glass-card border-rose-500/20 p-4">
    <strong class="text-rose-300 text-sm">3. 수치 계산 및 단위 환산 오류</strong>
    <p class="text-white/75 text-xs mt-1.5 leading-relaxed">
  ...
  <div class="glass-card border-rose-500/20 p-4">
    <strong class="text-rose-300 text-sm">4. 질문 속 잘못된 전제 무비판 수용</strong>
    <p class="text-white/75 text-xs mt-1.5 leading-relaxed">
  ...
  <div class="glass-card border-emerald-500/30 bg-emerald-950/20 p-5 flex flex-col justify-between">
    <div>
      <div class="text-emerald-300 font-bold text-base mb-2.5 flex items-center gap-2">
        ...
        <span>AI에게 맡길 일 : "쓰는 일 (초안/정리/요약)"</span>
      </div>
      <ul class="space-y-2.5 text-white/90 text-xs">
    ...
    <div class="text-xs text-emerald-300 font-bold border-t border-emerald-500/20 pt-2.5 mt-3">
  ...
  <div class="glass-card border-rose-500/30 bg-rose-950/20 p-5 flex flex-col justify-between">
    <div>
      <div class="text-rose-300 font-bold text-base mb-2.5 flex items-center gap-2">
        ...
        <span>사람이 직접 검증할 일 : "아는 일 (수치/사실/판단)"</span>
      </div>
      <ul class="space-y-2.5 text-white/90 text-xs">
    ...
    <div class="text-xs text-rose-300 font-bold border-t border-rose-500/20 pt-2.5 mt-3">
...
<div class="flex items-center justify-center my-4">
  <img src="/rctf-framework.png" alt="RCTF 프레임워크" class="rounded-xl max-h-76 w-auto object-contain shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/10" />
</div>
...
<div class="grid grid-cols-2 gap-5 my-4 text-xs">
<v-clicks>
  <div class="glass-card border-white/10 p-5">
    <div class="text-white font-bold text-sm mb-2.5 flex items-center gap-2">
      ...
      <span>Zero-Shot (설명만 길게 늘어놓음)</span>
    </div>
  ...
  <div class="glass-card border-sky-500/30 bg-sky-950/20 p-5">
    ...
    <p class="text-xs text-sky-300 font-bold leading-relaxed">
...
<div class="flex items-center justify-center my-4">
  <img src="/rag-architecture.png" alt="RAG 시스템 아키텍처" class="rounded-xl max-h-76 w-auto object-contain shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/10" />
</div>
...
<div class="p-3 bg-emerald-950/20 border border-emerald-500/20 rounded-xl text-xs text-emerald-300 text-center mt-3 font-medium">
...
<div class="flex items-center justify-center my-4">
  <img src="/agent-architecture.png" alt="AI 에이전트 구조" class="rounded-xl max-h-76 w-auto object-contain shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/10" />
</div>
...
<v-clicks>
  <div class="glass-card border-sky-500/20 p-4">
    <div class="flex items-center gap-1.5 text-sky-300 font-bold text-sm mb-1">
      ...
      <span>1. 수질 DB 조회</span>
    </div>
    <p class="text-white/70 text-xs">전 가두리 수온·DO 센서 864건 로그 전수 확인</p>
  </div>
  <div class="glass-card border-sky-500/20 p-4">
    <div class="flex items-center gap-1.5 text-sky-300 font-bold text-sm mb-1">
      <span class="i-carbon-analytics text-base"></span>
      <span>2. 급변 구간 식별</span>
    </div>
    <p class="text-white/70 text-xs">전일 대비 수온 +1.2℃ 상승 및 최저 DO 3.6 포착</p>
  </div>
  <div class="glass-card border-amber-500/20 p-4">
    ...
    <p class="text-white/70 text-xs">9/14 일지에서 A-03동 폐사 41미 급증 확인</p>
  </div>
  <div class="glass-card border-amber-500/20 p-4">
    <div class="flex items-center gap-1.5 text-amber-300 font-bold text-sm mb-1">
      <span class="i-carbon-cloudy text-base"></span>
      <span>4. 기상청 API 대조</span>
    </div>
    <p class="text-white/70 text-xs">풍속 4m/s, 파고 0.4m, 조류 정체 시점 확인</p>
  </div>
  <div class="glass-card border-emerald-500/20 p-4">
    <div class="flex items-center gap-1.5 text-emerald-300 font-bold text-sm mb-1">
      <span class="i-carbon-task text-base"></span>
      <span>5. 권고 조치 정리</span>
    </div>
    <p class="text-white/70 text-xs">주의 가두리 2개소(A-01, A-03) 우선 점검 권고</p>
  </div>
  <div class="glass-card border-emerald-500/20 p-4">
    <div class="flex items-center gap-1.5 text-emerald-300 font-bold text-sm mb-1">
    ...
    <p class="text-white/70 text-xs">06:00 정각에 관리자 스마트폰으로 전송 완료</p>
  </div>
</v-clicks>
</div>
...
<div class="flex items-center justify-center my-4">
  <img src="/automation-4levels.png" alt="자동화 4단계 수준" class="rounded-xl max-h-76 w-auto object-contain shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/10" />
</div>
...
<v-clicks>
  <div class="glass-card border-t-2 border-t-emerald-400 p-4 flex flex-col justify-between">
    <div>
      <div class="text-xs font-mono text-emerald-300 font-bold mb-2">1단계 (즉시~3개월)</div>
      <h3 class="font-bold text-white text-sm mt-1 mb-2 flex items-center gap-1.5"><span class="i-carbon-document-tasks text-emerald-400 text-base"></span>문서 업무 + RAG</h3>
      <p class="text-xs text-white/75 leading-relaxed">작업일지 Few-shot 정리<br>고시문 RAG 질의응답</p>
    </div>
    <div class="text-xs text-emerald-300 border-t border-white/10 pt-2.5 mt-3 font-medium">
  ...
  <div class="glass-card border-t-2 border-t-sky-400 p-4 flex flex-col justify-between">
    <div>
      <div class="text-xs font-mono text-sky-300 font-bold mb-2">2단계 (3~12개월)</div>
      <h3 class="font-bold text-white text-sm mt-1 mb-2 flex items-center gap-1.5"><span class="i-carbon-chart-line-data text-sky-400 text-base"></span>기록 표준화 & 이상탐지</h3>
      <p class="text-xs text-white/75 leading-relaxed">동별·숫자 기록 정착<br>센서 수질 급변 이상탐지</p>
    </div>
    <div class="text-xs text-sky-300 border-t border-white/10 pt-2.5 mt-3 font-medium">
  ...
  <div class="glass-card border-t-2 border-t-indigo-400 p-4 flex flex-col justify-between">
    <div>
      <div class="text-xs font-mono text-indigo-300 font-bold mb-2">3단계 (1~2년)</div>
      <h3 class="font-bold text-white text-sm mt-1 mb-2 flex items-center gap-1.5"><span class="i-carbon-chart-cluster-bar text-indigo-400 text-base"></span>폐사·성장 예측 솔루션</h3>
      <p class="text-xs text-white/75 leading-relaxed">고수온 조기 경보<br>급이량·성장 곡선 분석</p>
    </div>
    <div class="text-xs text-indigo-300 border-t border-white/10 pt-2.5 mt-3 font-medium">
      전제: <strong>동별 숫자 기록 1년 이상</strong>
    </div>
  </div>

  <div class="glass-card border-t-2 border-t-purple-400 p-4 flex flex-col justify-between">
    <div>
      <div class="text-xs font-mono text-purple-300 font-bold mb-2">4단계 (2년 이후~)</div>
      <h3 class="font-bold text-white text-sm mt-1 mb-2 flex items-center gap-1.5"><span class="i-carbon-bot text-purple-400 text-base"></span>영상인식 & 에이전트</h3>
      <p class="text-xs text-white/75 leading-relaxed">수중영상 어체 계수<br>급이 연동 자동 브리핑</p>
    </div>
    <div class="text-xs text-purple-300 border-t border-white/10 pt-2.5 mt-3 font-medium">
...
<div class="grid grid-cols-3 gap-4 my-4 text-xs">
<v-clicks>
  <div class="glass-card border-white/10 p-4 flex flex-col justify-between">
    <div>
      <span class="text-amber-300 font-bold text-sm">문제 1: 폐사 경보(0.78) 수신</span>
  ...
  <div class="glass-card border-white/10 p-4 flex flex-col justify-between">
    <div>
      <span class="text-amber-300 font-bold text-sm">문제 2: 정확도 97%의 허점</span>
      <div class="p-3 bg-black/40 rounded-xl mt-2.5 space-y-1.5 text-xs text-white/85 leading-relaxed">
  ...
  <div class="glass-card border-white/10 p-4 flex flex-col justify-between">
    <div>
      <span class="text-amber-300 font-bold text-sm">문제 3: 아침 브리핑 에이전트</span>
      <div class="p-3 bg-black/40 rounded-xl mt-2.5 space-y-1.5 text-xs text-white/85 leading-relaxed">
...
<v-clicks>
  <div class="flex items-center gap-3">
    <span class="w-8 h-8 rounded-full bg-sky-500/20 text-sky-300 flex items-center justify-center text-sm font-bold flex-shrink-0">1</span>
    <p class="leading-relaxed"><strong>기록이 없으면 AI도 없다:</strong> 동별 분리, 숫자 표기, 결측치 구분으로 1년 치 사육 데이터를 축적하세요.</p>
  </div>
  <div class="flex items-center gap-3">
    <span class="w-8 h-8 rounded-full bg-indigo-500/20 text-indigo-300 flex items-center justify-center text-sm font-bold flex-shrink-0">2</span>
    <p class="leading-relaxed"><strong>경보는 알람일 뿐, 조치는 실측으로:</strong> 공급업체 정확도 97%에 속지 말고 재현율을 검증하며, 최종 근거는 현장 실측입니다.</p>
  </div>
  <div class="flex items-center gap-3">
    ...
    <p class="leading-relaxed"><strong>되돌릴 수 없는 일은 사람이 승인한다:</strong> AI 에이전트는 분석과 브리핑을 맡기고, 약품 투여와 출하 판단은 사람이 지킵니다.</p>
  </div>
</v-clicks>
</div>
