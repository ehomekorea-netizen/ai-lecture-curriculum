...
<template>
  <div class="w-full flex flex-col justify-between select-none font-sans text-slate-100 text-left h-[330px] my-auto">
    ...
    <div class="flex items-center justify-between bg-white/6 px-3 py-1.5 rounded-xl border border-white/10 shadow-2xs mb-2">
    ...
    <div class="grid grid-cols-12 gap-3.5 items-stretch h-[270px]">
      ...
      <div class="col-span-7 flex flex-col justify-between bg-white/6 rounded-2xl border border-white/10 p-3 shadow-2xs">
        <div>
          <!-- Starter Prompt Header -->
          <div class="flex items-center justify-between pb-1.5 border-b border-slate-100 mb-1.5">
            <span class="text-[11px] font-bold text-white font-serif flex items-center gap-1">
          ...
          <!-- Introduction text -->
          <div class="text-[10.5px] text-slate-400 leading-snug break-keep">
            <strong class="text-white font-serif block mb-0.5">📌 회의록 타이핑 부담 100% 해소</strong>
        ...
        <div class="pt-1.5 border-t border-slate-100 flex items-center justify-between text-[9.5px] text-slate-400 font-mono">
      ...
      <div class="col-span-5 flex flex-col justify-between bg-white/6 rounded-2xl border border-white/10 p-3 shadow-2xs">
        <div>
          <span class="text-[11px] font-bold text-white font-serif block mb-2">
            3-Step 에이전트 실행 흐름
          </span>

          <!-- 3 Steps -->
          <div class="space-y-1.5">
            <div class="p-1.5 px-2.5 rounded-lg bg-white/6 border border-white/10 flex items-start gap-2 shadow-2xs">
              ...
              <div>
                <strong class="text-[10.5px] text-white block font-serif leading-tight">음성 전사 & 화자 분리 (Whisper)</strong>
                <span class="text-[9.5px] text-slate-400">참여자별 핵심 발언 요약 및 타임스탬프 기록</span>
              </div>
            </div>
            ...
            <div class="p-1.5 px-2.5 rounded-lg bg-white/6 border border-white/10 flex items-start gap-2 shadow-2xs">
              ...
              <div>
                <strong class="text-[10.5px] text-white block font-serif leading-tight">의결 사항 & 쟁점 매트릭스 도출</strong>
                <span class="text-[9.5px] text-slate-400">원안 가결, 수정 합의, 보류 안건 구조화</span>
              </div>
            </div>

            <div class="p-1.5 px-2.5 rounded-lg bg-white/6 border border-white/10 flex items-start gap-2 shadow-2xs">
              <span class="w-4 h-4 rounded-full bg-emerald-100 text-emerald-300 text-[9.5px] font-bold font-mono flex items-center justify-center shrink-0 mt-0.5">3</span>
              <div>
                <strong class="text-[10.5px] text-white block font-serif leading-tight">공식 DOCX 회의록 & 실행과제표 렌더링</strong>
                <span class="text-[9.5px] text-slate-400">공공 표준 서식 회의록 + 담당자별 To-Do 표 완성</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="pt-2 border-t border-white/10">
          <div class="flex items-center justify-between text-[9.5px]">
            <span class="font-bold text-slate-300">Skills to consider:</span>
