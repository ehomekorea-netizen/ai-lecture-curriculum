...
<template>
  <div>
    ...
    >
      <div
        class="clip bg-gradient-to-r from-[#003bb3] to-[#001f80]"
        :style="{ 'clip-path': `polygon(${poly1})`, 'opacity': opacity }"
      />
      <div
        class="clip bg-gradient-to-l from-[#0284c7] to-[#0369a1]"
        :style="{ 'clip-path': `polygon(${poly2})`, 'opacity': opacity }"
      />
      <div
        class="clip bg-gradient-to-t from-[#60a5fa] to-[#38bdf8]"
        :style="{ 'clip-path': `polygon(${poly3})`, 'opacity': 0.25 }"
      />
    </div>
  </div>
</template>
