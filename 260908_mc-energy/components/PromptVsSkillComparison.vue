  ...
  <div class="w-full flex flex-col justify-between py-2 select-none">
    ...
    <div class="grid grid-cols-12 gap-8 items-stretch">
      ...
      <div class="col-span-5 p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-lg flex flex-col justify-between h-80">
        <div>
          <div class="flex items-center justify-between mb-4 border-b border-white/10 pb-3">
            <span class="text-xs font-mono font-bold text-white/70 uppercase">PROMPT (1회성 지시)</span>
            <span class="text-[11px] font-mono text-white/40">개인 단위</span>
          </div>

          <div class="p-3.5 rounded-xl bg-black/40 font-mono text-xs text-white/80 border border-white/10 mb-3">
            "이번에 이 업무 처리해줘."
          </div>

          <ul class="text-xs text-white/60 space-y-1.5 pl-4 m-0 leading-relaxed">
        ...
        <div class="pt-3 border-t border-white/10 text-xs font-mono text-white/40">일회성 실행</div>
      </div>
      ...
      <div class="col-span-2 flex flex-col items-center justify-center">
        ...
        <span class="text-[11px] font-mono text-white/40 mt-2">업무 자산화</span>
      </div>

      <!-- Right: Skill -->
      <div
        class="col-span-5 p-6 rounded-2xl border border-blue-500/30 bg-blue-950/20 backdrop-blur-md shadow-xl flex flex-col justify-between h-80 transition-all duration-500"
      ...
      >
        <div>
          <div class="flex items-center justify-between mb-4 border-b border-blue-500/20 pb-3">
            <span class="text-xs font-mono font-bold text-blue-300 uppercase">SKILL (재사용 업무 매뉴얼)</span>
            <span class="text-[11px] font-mono text-blue-400">조직 단위</span>
          </div>

          <div class="p-3.5 rounded-xl bg-black/40 font-mono text-xs text-blue-200 border border-blue-500/20 mb-3">
        ...
        <div class="pt-3 border-t border-blue-500/20 text-xs font-mono font-bold text-blue-300">표준 업무 자산</div>
      </div>
    ...
    >
      ...
      <span class="text-[11px] font-mono text-white/40">Prompt ➔ Skill</span>
    </div>
