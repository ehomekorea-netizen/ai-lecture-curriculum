...
import { Refractive } from '../setup/liquid-glass'

const props = withDefaults(defineProps<{
  as?: string
  glow?: 'pink' | 'cyan' | 'amber' | 'blue' | 'emerald' | 'violet' | 'neutral'
  radius?: number
}>(), {
  as: 'div',
  glow: 'neutral',
