---
theme: default
title: AI를 활용한 실무 문서 작성 및 취업 역량 강화
info: 밀양시 청년·청소년 취업역량 강화교육 - 6주차
colorSchema: light
...
<p class="subtitle">AI의 본질에서 실무 프롬프트, 도구 협업, 그리고 <strong>직무 스킬 자산화까지</strong></p>
...
const tocItems = [
  ...
  { num: '04', title: '나만의 스킬 구축과 취업 자산화', en: 'Skill & Assetization' },
]
</script>
...
<p class="subtitle">단 1번의 지시로 <strong>[경험DB탐색 ➔ 직무역량매핑 ➔ 기획서초안 ➔ 성과분석]</strong>을 완수하는 자율 실행 시뮬레이터</p>
...
<SectionPartDivider
  ...
  subtitle="자료가 없는 상태에서 AI와 함께 Deep Research부터 실무 프로젝트 기획서 초안 및 AI 검토까지 완성하는 실전 워크플로우"
...
<p class="subtitle">"무엇이든 묻는 AI"와 <strong>"내 경험과 공고를 기준으로 묻는 AI"</strong>의 결정적 차이</p>
...
# 실전 실습: 자료가 없는 상태에서 프로젝트 문서 만들기

<p class="subtitle">신입 맞춤형 실무 포트폴리오 기획 — <strong>채용조사 ➔ 선별 ➔ 분석 ➔ 지식환류 ➔ 초안 ➔ 검토</strong></p>
...
<SectionPartDivider
  ...
  subtitle="단순 대화를 넘어, 로컬 폴더 연결과 플러그인·스킬로 완성하는 고품질 포트폴리오 산출물(DOCX)"
...
<p class="subtitle">단순 대화를 넘어 <strong>실제 실무 업무(기획서·슬라이드·분석표)를 위임</strong>하고 완성형 파일을 받는 업무 실행 환경</p>
...
# 실무 Use Case: 채용 가이드 분석 및 피치덱 작성

<p class="subtitle">채용 가이드(PDF)를 <strong>@Documents & @Presentations</strong>로 분석하여 <strong>기획서와 면접 피치덱</strong> 동시 완성</p>
...
# 실무 Use Case: 직무스킬 분석 및 맞춤 전략서 작성

<p class="subtitle">기본 데이터 분석 기능으로 통계·차트를 도출하고, <strong>@Documents</strong>로 맞춤 전략서(DOCX) 완성</p>
...
<p class="subtitle">오늘 배운 플러그인을 자유롭게 조합해 <strong>포트폴리오의 작은 문제 하나를 해결해봅니다.</strong></p>
...
<p class="subtitle">AI가 만든 문서는 초안입니다. <strong>최종 확인은 작성자(교육생)가 합니다.</strong></p>
...
# 실무 Use Case: 프로젝트 경험 정리 스킬 제작

<p class="subtitle">프로젝트 활동 기록과 커밋 데이터를 <strong>@skill-creator</strong>로 나만의 전용 STAR 포트폴리오 스킬로 자산화</p>
...
<p class="subtitle">이제, 나의 포트폴리오 작업 하나를 <strong>스킬로 만들어보세요</strong></p>
