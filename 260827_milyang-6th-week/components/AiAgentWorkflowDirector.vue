...
const fullPrompt = '밀양 취업역량 교육에서 진행한 내 프로젝트 기록을 바탕으로 신입 서비스기획 포트폴리오 기획서 작성 및 직무 역량 분석표 정리해줘.'
      ...
      <div class="flex-1 py-1.5 space-y-1.5 overflow-hidden text-xs flex flex-col justify-start">
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <span class="text-slate-400 font-sans text-[10px] truncate max-w-[420px]">➔ view_file("내_프로젝트_활동기록_및_경험DB.md")</span>
          </div>
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <span class="text-slate-300 font-sans text-[10px] truncate max-w-[420px]">➔ 수강생 활동 로그 5개 항목 추출, 지원 기업 요구 역량과 매핑 완료</span>
          </div>
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <span class="text-slate-300 font-mono text-[9.5px] truncate max-w-[390px]">python analyze_skills.py --my-project "AI포트폴리오" --target-role "서비스기획"</span>
          </div>
          <span v-if="streamStep >= 4" class="text-[9px] text-emerald-400 font-bold font-mono">5 Skills (OK)</span>
          <ChevronRight v-else :size="11" class="text-slate-500" />
        </div>
        ...
        >
          <div class="flex items-center gap-2 font-sans">
            ...
            <span class="font-bold text-slate-100 tracking-tight">2026_신입직무_포트폴리오_기획서_최종.md</span>
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <span class="text-slate-300 text-[10px] font-sans">
              {{
                streamStep === 1 ? '수강생 프로젝트 경험 DB 및 활동 기록 색인 탐색 중...' :
                streamStep === 2 ? '다단계 실행 계획 수립 및 직무 역량 매핑 중...' :
                streamStep === 3 ? '파이썬 연산 도구 호출 및 직무 역량 분석 중...' :
                '2026 신입 포트폴리오 기획서 최종본 마크다운 생성 및 저장 중...'
              }}
            </span>
          </div>
        ...
        >
          ...
          <div class="flex items-center justify-between gap-3 pr-1">
            <div class="text-[11.5px] font-sans text-slate-100 font-medium leading-snug">
              밀양시 취업역량강화 교육생을 위한 신입 직무 포트폴리오 기획서 작성을 완료하였습니다! 🚀
            </div>
      ...
      >
        ...
        <div class="text-center pb-1.5 border-b-2 border-slate-900 shrink-0">
          <div class="flex items-center justify-between text-[8.5px] font-mono text-slate-500 mb-0.5">
            <span>[문서번호: 2026-밀양-포트폴리오-01]</span>
          ...
          <h2 class="text-sm md:text-[14.5px] font-serif font-black text-slate-900 tracking-tight leading-tight">
            2026년도 신입 직무 실무 프로젝트 포트폴리오 기획서
          </h2>
          <div class="text-[9px] font-sans text-slate-600 mt-0.5">
            작성자: 밀양시 취업역량강화 수강생 (서비스기획 희망)
          </div>
        </div>
        ...
        <div class="flex-1 py-1.5 space-y-1.5 text-[10px] font-sans flex flex-col justify-between">
          ...
          <div class="space-y-0.5">
            ...
            <table class="w-full text-[9px] border-collapse border border-slate-300">
              <tbody>
                <tr>
                  <td class="bg-slate-100 p-0.5 px-1 font-bold border border-slate-300 w-16 text-slate-700">프로젝트명</td>
                  <td class="p-0.5 px-1 border border-slate-300 text-slate-800 font-medium">생성형 AI 에이전트 기반 실무 프로세스 자동화</td>
                </tr>
                <tr>
                  <td class="bg-slate-100 p-0.5 px-1 font-bold border border-slate-300 text-slate-700">수행기간</td>
                  <td class="p-0.5 px-1 border border-slate-300 text-slate-800">2026. 07. 01 ~ 2026. 08. 24 (교육 실습 프로젝트)</td>
                </tr>
                <tr>
                  <td class="bg-slate-100 p-0.5 px-1 font-bold border border-slate-300 text-slate-700">목표직무</td>
                  <td class="p-0.5 px-1 border border-slate-300 text-slate-800">IT 서비스 기획 / PM (신입 채용 지원용)</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="w-full text-[9px] text-center border-collapse border border-slate-300">
              <thead>
                <tr class="bg-slate-100 text-slate-700 font-bold">
                  ...
                  <th class="p-0.5 border border-slate-300">기존 수동 작성</th>
                  <th class="p-0.5 border border-slate-300">AI 에이전트 협업</th>
                  <th class="p-0.5 border border-slate-300 text-indigo-700">효율성</th>
                </tr>
              </thead>
              <tbody class="text-slate-800 font-medium">
                <tr>
                  <td class="p-0.5 border border-slate-300 font-bold">기획서 작성</td>
                  <td class="p-0.5 border border-slate-300">12.0 시간</td>
                  <td class="p-0.5 border border-slate-300 font-bold text-slate-900">2.5 시간</td>
                  <td class="p-0.5 border border-slate-300 font-bold text-indigo-700 bg-indigo-50">-79.2% 단축</td>
                </tr>
              </tbody>
            </table>
          </div>
