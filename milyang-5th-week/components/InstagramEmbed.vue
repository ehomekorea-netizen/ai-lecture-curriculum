...
<template>
  <div class="insta-exact-wrapper w-full h-[360px] flex items-center justify-center select-none">
    ...
    <div class="insta-window rounded-2xl overflow-hidden border border-slate-200/90 bg-white shadow-xl">
      <!-- Scaler Layer: Exactly offsets 48px header and matches 440px (3:4) media height perfectly -->
...
/* 3:4 Aspect Ratio Box (264px x 352px = 1 : 1.3333) */
.insta-window {
  width: 264px;
  height: 352px;
  position: relative;
