...
new_s1 = '''            <!-- 1차시 마무리 카드 -->
            <div class="page-block summary-block">
                <div class="page-block-header">
                    <h3><i class="fa-solid fa-flag-checkered"></i> 🏁 1·2·3차시 마무리 카드 완벽 통일 규격 — 1차시</h3>
                </div>
                <div class="summary-card-box" style="padding:24px; background:linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border:2.5px solid #4ade80; border-radius:16px; box-shadow:0 6px 20px rgba(22, 101, 52, 0.12);">
                    ...
                    <p style="color:#14532d; font-size:22px; text-align:center; font-weight:900; margin:0 0 18px 0; line-height:1.55;">
                        ...
                        AI에게 3원칙(<strong class="red-target">[역할]+[맥락]+[형식]</strong>)으로 제대로 물어<br>
                        3초 현장 관제표를 완성합니다!"
                    </p>
...
new_s2 = '''            <!-- 2차시 마무리 카드 -->
            <div class="page-block summary-block">
                <div class="page-block-header">
                    <h3><i class="fa-solid fa-flag-checkered"></i> 🏁 1·2·3차시 마무리 카드 완벽 통일 규격 — 2차시</h3>
                </div>
                <div class="summary-card-box" style="padding:24px; background:linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border:2.5px solid #4ade80; border-radius:16px; box-shadow:0 6px 20px rgba(22, 101, 52, 0.12);">
                    <div style="text-align:center; margin-bottom:14px;">
                        <span style="display:inline-block; background:linear-gradient(90deg, #15803d, #16a34a); color:#fff; font-size:14px; font-weight:900; padding:5px 18px; border-radius:20px; letter-spacing:0.5px;">
                    ...
                    <p style="color:#14532d; font-size:22px; text-align:center; font-weight:900; margin:0 0 18px 0; line-height:1.55;">
                        ...
                        최종 완성은 어민의 30년 현장 경험과 도메인 데이터가<br>
...
new_s3 = '''            <!-- 3차시 마무리 카드 -->
            <div class="page-block summary-block">
                <div class="page-block-header">
                    <h3><i class="fa-solid fa-flag-checkered"></i> 🏁 1·2·3차시 마무리 카드 완벽 통일 규격 — 3차시</h3>
                </div>
                <div class="summary-card-box" style="padding:24px; background:linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border:2.5px solid #4ade80; border-radius:16px; box-shadow:0 6px 20px rgba(22, 101, 52, 0.12);">
                    <div style="text-align:center; margin-bottom:14px;">
                        <span style="display:inline-block; background:linear-gradient(90deg, #15803d, #16a34a); color:#fff; font-size:14px; font-weight:900; padding:5px 18px; border-radius:20px; letter-spacing:0.5px;">
                    ...
                    <p style="color:#14532d; font-size:22px; text-align:center; font-weight:900; margin:0 0 18px 0; line-height:1.55;">
                        "매번 길게 설명할 필요 없이!<br>
                        내 양식장의 수조·어종 특성을 기억하는 어민 전담 AI 비서로<br>
                        수질 경보부터 일지까지 자동합니다!"
                    </p>
                    <div style="display:flex; align-items:center; justify-content:center; gap:8px; flex-wrap:wrap; margin-top:4px;">
                        ...
                        <span style="color:#15803d; font-size:22px; font-weight:900;">→</span>
                        <span style="background:#15803d; border:1.5px solid #15803d; border-radius:10px; padding:8px 14px; font-size:14px; font-weight:800; color:#ffffff; white-space:nowrap;">🚀 스마트 양식장 활퇴근 완수</span>
                    </div>
                </div>
                <div class="brand-footer-line">
...
# 라인 번호로 각 블록 교체 (뒤에서부터 교체해야 라인 번호 안 밀림)
# 3차시 먼저, 2차시, 1차시 순으로

# 3차시 블록: summary-block 3번째 = 라인 1422~1434 (0-indexed: 1421~1433)
# 2차시 블록: summary-block 2번째 = 라인 959~971 (0-indexed: 958~970)
# 1차시 블록: summary-block 1번째 = 라인 518~530 (0-indexed: 517~529)

# summary-block 위치들 찾기
positions = []
for i, line in enumerate(lines):
    if 'page-block summary-block' in line:
        positions.append(i)
        
print(f"Found {len(positions)} summary-blocks at lines: {[p+1 for p in positions]}")
